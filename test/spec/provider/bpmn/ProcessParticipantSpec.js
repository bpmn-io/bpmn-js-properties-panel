...
describe('process-participant-properties', function() {
  ...
  it('should get the id of the participant',
    ...
    // given
    var shape = elementRegistry.get('_Participant_2');
    var particpant = getBusinessObject(shape);
    ...
    expect(input.value).to.equal(particpant.get('id'));
  }));
  ...
  it('should get the name of the participant',
    ...
    expect(input.value).to.equal(particpant.get('name'));
  }));


  describe('change name of particpant', function() {

    var container, particpant, textarea;
    ...
    beforeEach(inject(function(elementRegistry, selection, propertiesPanel){
      ...
      particpant = getBusinessObject(shape);
    ...
    describe('on the business object', function() {
      ...
      it('should execute', function() {
        // then
        expect(particpant.get('name')).to.equal('foo');
      });
      ...
      it('should undo', inject(function(commandStack) {
        ...
        // then
        expect(particpant.get('name')).to.equal('Pool');
      }));
