...
function getEscalationDefinitionsField(container) {
  return getSelectField(container, 'escalation-definitions', 'escalation');
}
...
function getEscalationNameField(container) {
  return getInputField(container, 'escalation-definition-name', 'escalationName');
}

function getEscalationCodeField(container) {
  return getInputField(container, 'escalation-definition-code', 'escalationCode');
}
