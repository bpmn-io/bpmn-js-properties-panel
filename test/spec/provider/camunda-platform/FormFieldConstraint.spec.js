...
describe('provider/camunda-platform - FormFieldConstraint', function() {
  ...
  describe('#Name', function() {
    ...
    it('should display', inject(async function(elementRegistry, selection) {
      ...
      const nameInput = domQuery('#bio-properties-panel-UserTask_1-formField-0-constraints-field-1-name', container);
  ...
  describe('#Config', function() {
    ...
    it('should display', inject(async function(elementRegistry, selection) {
      ...
      const configInput = domQuery('#bio-properties-panel-UserTask_1-formField-0-constraints-field-1-config', container);
      const validation = getFormFieldValidation(task, 0);
