...
describe('provider/camunda-platform - FormFieldProperty', function() {
  ...
  describe('#ID', function() {
    ...
    it('should display', inject(async function(elementRegistry, selection) {
      ...
      const idInput = domQuery('#bio-properties-panel-UserTask_1-formField-0-properties-field-0-id', container);
  ...
  describe('#Value', function() {
    ...
    it('should display', inject(async function(elementRegistry, selection) {
      ...
      const valueInput = domQuery('#bio-properties-panel-UserTask_1-formField-0-properties-field-0-value', container);
      const properties = getFormFieldProperties(task, 0);
