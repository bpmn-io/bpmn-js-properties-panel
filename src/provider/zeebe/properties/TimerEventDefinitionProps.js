...
function getTimerEventDefinitionValueDescription(timerDefinitionType, translate) {
  ...
  case 'timeDate':
    return (<div>
      ...
      <a href="https://docs.camunda.io/docs/reference/bpmn-processes/timer-events/timer-events/#time-date" target="_blank">{ translate('Documentation: Timer events') }</a>
    </div>);
  ...
  case 'timeCycle':
    return (<div>
      ...
      <a href="https://docs.camunda.io/docs/reference/bpmn-processes/timer-events/timer-events/#time-cycle" target="_blank">{ translate('Documentation: Timer events') }</a>
    </div>);
  ...
  case 'timeDuration':
    return (<div>
      ...
      <a href="https://docs.camunda.io/docs/reference/bpmn-processes/timer-events/timer-events/#time-duration" target="_blank">{ translate('Documentation: Timer events') }</a>
    </div>);
