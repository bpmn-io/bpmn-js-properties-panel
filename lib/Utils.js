...
function findParentElementByType(businessObject, referencedType) {
  var parent = businessObject;
  while (!is(parent,'bpmn:Process') && parent.$parent) {
    parent = parent.$parent;
  }
  return parent;
};

module.exports.findParentElementByType = findParentElementByType;
