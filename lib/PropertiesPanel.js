...
PropertiesPanel.prototype._bindListeners = function(container) {
  ...
  var handleChange = function handleChange(event) {
    ...
    noUpdateOnInput = domAttr(inputNode, 'data-no-update-on-input');

    // skip change on <input> if wanted
    if (event.type === 'input' && noUpdateOnInput) {
      return;
    }
