...
module.exports = function(group, element, bpmnFactory) {
  ...
  var elementDocuEntry = entryFactory.textArea({
    id: 'documentation',
    description: '',
  ...
  if (is(element, 'bpmn:Participant')) {
    var processDocuEntry = entryFactory.textArea({
    ...
    processDocuEntry.set = setValue(getBusinessObject(element).processRef);

    processDocuEntry.get = getValue(getBusinessObject(element).processRef);
