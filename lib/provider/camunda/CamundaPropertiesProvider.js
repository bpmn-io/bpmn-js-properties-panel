...
var serviceTaskDelegateProps = require('./parts/ServiceTaskDelegateProps'),
  ...
  extensions = require('./parts/ExtensionsProps');
...
function createExtensionsTabGroups(element, bpmnFactory, elementRegistry) {

  var PropertiesGroups = {
    id: 'camunda-properties',
    label: 'Properties',
    entries: []
  };
  extensions(PropertiesGroups, element, bpmnFactory);
...
function CamundaPropertiesProvider(eventBus, bpmnFactory, elementRegistry) {
  ...
  this.getTabs = function(element) {
    ...
    var extensionsTab = {
      id: 'extensions',
      label: 'Extensions',
      groups: createExtensionsTabGroups(element, bpmnFactory, elementRegistry)
    };
