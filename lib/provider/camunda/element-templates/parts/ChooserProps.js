...
module.exports = function(group, element, elementTemplates) {
  ...
  if (options.length === 1) {
    ...
    if (options[0].isDefault) {
      // TODO disable select box (currently disabling means hiding the select box)
      console.log('TODO disable select box (currently disabling means hiding the select box)');
