...
function ChangeElementTemplateHandler(modeling, commandStack, bpmnFactory) {
  ...
  function updateIoMappings(element, newTemplate, context, insideProperties) {
  ...
  function updateCamundaProperties(element, newTemplate, context, insideProperties) {
  ...
  function updateInOut(element, newTemplate, context, insideProperties) {
  ...
  function updateExecutionListener(element, newTemplate, context, insideProperties) {
  ...
  function updateScopeElements(element, scopeName, scope) {
    ...
    var insideProperties = scope.insideProperties || false;
    ...
    updateIoMappings(scopeElement, scope, scopeElement, insideProperties);

    // update camunda:properties
    updateCamundaProperties(scopeElement, scope, scopeElement, insideProperties);
    ...
    updateInOut(scopeElement, scope, scopeElement, insideProperties);

    // update camunda:executionListener
    updateExecutionListener(scopeElement, scope, scopeElement, insideProperties);
