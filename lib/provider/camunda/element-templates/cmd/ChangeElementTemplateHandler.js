...
function ChangeElementTemplateHandler(modeling, commandStack, bpmnFactory) {
  ...
  function updateIoMappings(element, newTemplate, context, inside) {
  ...
  function updateCamundaProperties(element, newTemplate, context, inside) {
  ...
  function updateInOut(element, newTemplate, context, inside) {
  ...
  function updateExecutionListener(element, newTemplate, context, inside) {
  ...
  function updateScopeElements(element, scope) {
    ...
    updateIoMappings(scopeElement, scope, scopeElement, inside);

    // update camunda:properties
    updateCamundaProperties(scopeElement, scope, scopeElement, inside);
    ...
    updateInOut(scopeElement, scope, scopeElement, inside);

    // update camunda:executionListener
    updateExecutionListener(scopeElement, scope, scopeElement, inside);
