...
function registerHandlers(commandStack, elementTemplates, eventBus, elementRegistry) {
  ...
  // apply default element templates on import element templates changed
  eventBus.on([ 'import.done', 'elementTemplates.changed' ], function() {

    elementRegistry.forEach(function(element) {
      applyDefaultTemplate(element, elementTemplates, commandStack);
    });
