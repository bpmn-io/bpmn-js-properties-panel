...
module.exports = function(group, element, bpmnFactory) {
  ...
  group.entries.push(
    {
      ...
      'html': '<div class="radios-group">' +
              ...
              '<div class="pp-row">' +
                ...
                '<div class="field-wrapper" data-show="isCollection">' +
  ...
  group.entries.push(entryFactory.checkbox({
    ...
    set: function(element, values) {
      ...
      resetExclusive(res, asyncBefore, !!bo.get('camunda:asyncAfter'));
  ...
  group.entries.push(entryFactory.checkbox({
    ...
    set: function(element, values) {
      ...
      return cmdHelper.updateBusinessObject(element, bo, { asyncAfter : !!values.loopAsyncAfter });
    }
  }));
