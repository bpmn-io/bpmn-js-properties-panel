...
module.exports = function(element, translate) {
  ...
  var description = entryFieldDescription(translate('Available process variables, identified in the diagram.'));
  ...
  if (!withNames.length) {
    var placeholder = entryFieldDescription(translate('No variables found.'));
