  ...
  template:
    '<div class="pp-row">' +
      ...
      '<div class="field-wrapper">' +
        ...
        '<button data-action="script.clearScriptFormat" data-show="script.canClearScriptFormat">' +
          '<span>X</span>' +
        '</button>' +
      '</div>' +
    '</div>' +
    ...
    '<div class="pp-row">' +
      ...
      '<div class="field-wrapper" data-show="script.isScriptResource">' +
        '<input id="cam-script-resource-val" type="text" name="scriptResourceValue" />' +
        '<button data-action="script.clearScriptResource" data-show="script.canClearScriptResource">' +
          '<span>X</span>' +
        '</button>' +
      '</div>' +
    '</div>' +
    ...
    '<div class="pp-row">' +
      ...
      '<div class="field-wrapper" data-show="script.isScript">' +
        '<textarea id="cam-script-val" type="text" name="scriptValue"></textarea>' +
        '<button data-action="script.clearScript" data-show="script.canClearScript">' +
          '<span>X</span>' +
        '</button>' +
      '</div>'+
    '</div>',
