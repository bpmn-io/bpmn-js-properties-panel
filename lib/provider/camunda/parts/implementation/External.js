...
module.exports = {
  ...
  template:
    '<div class="field-wrapper" data-show=external.isExternal>' +
      '</br>' +
      '<label for="camunda-ext-topic">Topic</label>' +
      '</br>' +
      '<input id="camunda-ext-topic" type="text" name="externalTopic" />' +
      '<button data-action="external.clear" data-show="external.canClear">' +
        '<span>X</span>' +
      '</button>' +
    '</div>',
