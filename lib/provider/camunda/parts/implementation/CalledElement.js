  ...
  template: 
    '<div class="pp-row">' +
      ...
      '<div class="field-wrapper">' +
        ...
        '<button data-action="calledElement.clear" data-show="calledElement.canClear">' +
          '<span>X</span>' +
        '</button>' +
      '</div>' +
    '</div>' +
    ...
    '<div class="pp-row" data-show="calledElement.isVersion">' +
      ...
      '<div class="field-wrapper">' +
        ...
        '<button data-action="calledElement.clearVersion" data-show="calledElement.canClearVersion">' +
          '<span>X</span>' +
        '</button>' +
      '</div>' +
    '</div>',
