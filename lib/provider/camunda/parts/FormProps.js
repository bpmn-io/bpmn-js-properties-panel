...
module.exports = function(group, element, bpmnFactory) {
  ...
  var formFieldsEntry = extensionElements(element, bpmnFactory, {
    ...
    removeExtensionElement: function(element, extensionElements, value, idx) {
      ...
      // var values = getExtensionElements(bo, 'camunda:FormData');
      // if (){
      //   commands.push(cmdHelper.removeElementsFromList(element, bo.extensionElements, 'values', 'extensionElements', entry));
      // }
      return commands;
    },
