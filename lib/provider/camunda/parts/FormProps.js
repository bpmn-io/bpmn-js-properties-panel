...
module.exports = function(group, element, bpmnFactory) {
  ...
  group.entries.push(entryFactory.table({
    ...
    addElement: function(element, node) {
      var bo = formHelper.getSelectedFormField(element, node);
      var newEntry = elementHelper.createElement('camunda:Constraint',
        { name: undefined, config: undefined }, bo.validation, bpmnFactory);
      return cmdHelper.addElementsTolist(element, bo.validation, 'constraints', [ newEntry ]);
    },
    ...
    removeElement: function(element, node, idx) {
      ...
      return cmdHelper.removeElementsFromList(element, formField.validation, 'constraints', null, [ constraint ]);
    },
