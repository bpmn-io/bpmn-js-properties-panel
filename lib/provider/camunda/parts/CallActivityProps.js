...
function getCallActivityType(element) {
...
module.exports = function(group, element, bpmnFactory) {
  ...
  group.entries.push(entryFactory.selectBox({
    ...
    selectOptions: [ { name: 'BPMN', value: 'bpmn' }, { name: 'CMMN', value: 'cmmn' }, { value: '' } ],
    modelProperty: 'callActivityType',

    get: function(element, node) {
      return {
        callActivityType: getCallActivityType(element)
      };
    },
  ...
  group.entries.push(callable(element, bpmnFactory, {
    getCallActivityType: getCallActivityType
  }));
